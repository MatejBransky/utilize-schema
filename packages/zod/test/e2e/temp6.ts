...
type CoreSchemaMetaSchemaBaseOutput = Omit<
	z.output<typeof CoreSchemaMetaSchemaBase>,
	'readOnly' | 'writeOnly' | 'uniqueItems'
> & {
	// Properties have to be optional because of the .default(true) in the final schema at the end
	readOnly?: boolean;
	writeOnly?: boolean;
	uniqueItems?: boolean;
};
