...
export const DbWriterStep = z.object({
	...
	dataWriteStrategy: z.enum(['APPEND', 'REPLACE']).default('APPEND').optional(),
});
...
export const Attribute = z.object({
	...
	id: z.string().uuid().default('unknownId').optional(),
});
export type Attribute = z.infer<typeof Attribute>;

export const GroupByExpressionAttribute = z.object({
	groupByExpression: z.string().default('').optional(),
	get attribute() {
...
export const GroupByExpressionConfiguration = z.object({
	isConvertible: z.boolean().default(false).optional(),
...
export const GroupByConfiguration = z.object({
	...
	get configuration() {
		return GroupByBasicConfiguration.optional();
	},
	get expressionConfiguration() {
		return GroupByExpressionConfiguration.optional();
	},
});
export type GroupByConfiguration = z.infer<typeof GroupByConfiguration>;

export const AggregationBasicAttribute = z.object({
	inputAttribute: z.string().default('').optional(),
...
export const AggregationExpressionAttribute = z.object({
	aggregationExpression: z.string().default('').optional(),
	get outputAttribute() {
		return Attribute.optional();
	},
});
...
export const AggregationConfiguration = z.object({
	asExpression: z.boolean().default(false).optional(),
	get configuration() {
		return AggregationBasicConfiguration.optional();
	},
	get expressionConfiguration() {
		return AggregationExpressionConfiguration.optional();
	},
});
...
export const GroupAggregatorStep = z.object({
	get groupBy() {
		return GroupByConfiguration.optional();
	},
	get aggregation() {
		return AggregationConfiguration.optional();
	},
});
...
export const JoinKey = z.object({
	...
	isExpression: z.boolean().default(false).optional(),
});
export type JoinKey = z.infer<typeof JoinKey>;

export const SelectedAttributes = z.object({
	attributes: z.array(z.string()).optional(),
	useAllAttributes: z.boolean().default(false).optional(),
});
...
export const JoinStep = z
	.object({
		joinType: z
			...
			.optional(),
		get leftKey() {
			return JoinKey.optional();
		},
		get rightKey() {
			return JoinKey.optional();
		},
		get leftAttributes() {
			return SelectedAttributes.optional();
		},
		get rightAttributes() {
			return SelectedAttributes.optional();
		},
...
export const OneDataWriterStep = z.object({
	tableId: z.string().uuid().default('unknownId').optional(),
});
export type OneDataWriterStep = z.infer<typeof OneDataWriterStep>;

export const OutputStep = z.object({
	passAllAttributes: z.boolean().default(true).optional(),
	attributes: z.array(z.string()).optional(),
});
...
export const TransformationCatalogItemOutputStep = z.object({
	structureLock: z.boolean().default(false).optional(),
	writeAllAttributes: z.boolean().default(true).optional(),
	attributes: z.array(z.string()).optional(),
});
