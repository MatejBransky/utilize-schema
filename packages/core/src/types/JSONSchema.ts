...
export interface JSONSchema extends JSONSchema7 {
	/**
	 * A reference to the original schema node, for convenience.
	 * This is used to track the original schema
	 * when dereferencing and normalizing.
	 */
	[Linked]?: Set<JSONSchema>;
